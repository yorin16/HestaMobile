...
function loadSlider(slider,default_text){
    ...
    /*if($(window).width()/2 < 1060){
        valor = length_gallery_item * 40;
    }*/
    w = $(window).width()/1.5 + ($(window).width()/2/2 / length_gallery_item) + valor;
    width = w / 3;
    slider.width(w);
...
$(document).ready(function() {
  ...
  function()
  {
    console.log(jQuery('.gallery_item[data-position="1"]').mouseenter());
  }, 50);
